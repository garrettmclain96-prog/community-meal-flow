...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      apply_for_kitchen_support: { Args: { _award_id: string }; Returns: string };
      apply_partner_organization: {
        Args: { _kind: string; _name: string; _service_areas: string[]; _website: string };
        Returns: string;
      };
    ...
    Enums: {
      app_role: "household" | "kitchen" | "nonprofit" | "sponsor" | "city_admin" | "platform_admin";
    };
    CompositeTypes: {
      [_ in never]: never;
    };
