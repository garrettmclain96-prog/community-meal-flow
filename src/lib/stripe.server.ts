...
export function getStripeSecretKey(env: StripeEnv): string {
  return env === "sandbox" ? getEnv("STRIPE_TEST_SECRET_KEY") : getEnv("STRIPE_LIVE_SECRET_KEY");
}

// ProvisionLoop talks directly to Stripe with owner-controlled secret keys.
// No connector gateway or third-party runtime proxy is involved.
